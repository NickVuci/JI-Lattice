...
function showTooltip(point, event) {
    ...
    let centsValue = ratioToCents(point.intervalDecimal);
    centsValue = ((centsValue % 1200) + 1200) % 1200; // Wrap cents to 0–1200 range
    const centsLabel = centsValue.toFixed(2) + 'c';
